...
*/
      ...
      ar: {
        ...
        optTalentDev: " منظمات تنميةالمواهب",
        ...
        optvc:"صناديق الاستثمار الجريئة",
        ...
        aboutMapp1: "يمثل هذا الدليل البصري نظرة شاملة على أبرز الفاعلين الذين يقودون مشهد الشركات الناشئة في سوريا.\n أُنجز العمل من قبل Aram Lab بدعم من السوريين داخل البلاد وخارجها، ليكون خريطة تفصيلية تسلّط الضوء على التنوع القائم في الأطراف المؤثرة بالمنظومة.\n يوضح الدليل أن بيئة الشركات الناشئة في سوريا ما تزال مجزأة وغير منظمة، ويسعى عبر رسم ملامح الفاعلين وأدوارهم إلى توضيح من يقوم بماذا، وتحديد مجالات التنافس، ورصد الفجوات القائمة.\n والغاية النهائية من هذا الجهد هي استخدام هذه المعلومات التأسيسية لبناء منظومة ريادة أعمال أكثر ترابطاً واستدامة وتماسكاً في سوريا.",
        ...
        footercopy:"جميع الحقوق محفوظة  © 2024 Aram Lab. ",
        ...
        aboutUstitle: "من نحن",
        aboutUsh4: "Aram Lab: مهندس المنظومات",
        aboutUsp1:"Aram Lab هي شركة استشارية في هندسة المنظومات مقرها ألمانيا، تأسست بواسطة مجموعة من الخبراء والباحثين. مهمتنا هي تعزيز تصميم وتطوير منظومات مستدامة في سوريا.",
        ...
        aboutUsp5:"جميع الحقوق محفوظة  © 2024 Aram Lab." ,
        source:"المصدر: البيانات جمعتها Aram Lab",
